...
I am a **Biotechnology & Genetic Engineering student** with a passion for **research, bioinformatics, and modern web technologies**.  
I am exploring the intersection between **life science and software engineering** to build innovative solutions.

Currently, I am:

- 🔬 Working on microbiology and genomics-related research projects.
- 🧬 Exploring bacterial identification, whole genome sequencing, and bioinformatics analysis.
- 💻 Building full-stack web applications using Next.js, React, Node.js, and MongoDB.
- 🌱 Learning advanced web development and improving my problem-solving skills.
- 🚀 Developing projects that combine creativity, technology, and real-world applications.
